...
const routes: Routes = [
  ...
  { path: 'brokerfee-requests', component: BrokerfeeListComponent, canActivate: [AuthGuard]},
  { path: 'brokerfee-request', component: BrokerfeeRequestComponent, canActivate: [AuthGuard]},
